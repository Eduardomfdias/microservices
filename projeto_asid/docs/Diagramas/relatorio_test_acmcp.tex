...
\acmCodeLink{https://github.com/Eduardomfdias/microservices}
\acmDataLink{https://github.com/Eduardomfdias/microservices}
\acmContributions{ED, NM, CK, and GK conducted the experiments, analyzed the results, and wrote the manuscript.}
...
Trabalho futuro prioritário: (1) teste do C5 além de 150u para determinar o seu verdadeiro ponto de saturação; (2) carga agressiva até colapsar o \texttt{redis-cart} com Envoy (H2/H5 inconclusivas); (3) avaliação de HPA nativo (Horizontal Pod Autoscaler) sobre o sistema com \textit{proxy} L7 para ajustar autonomamente ao tráfego real.
