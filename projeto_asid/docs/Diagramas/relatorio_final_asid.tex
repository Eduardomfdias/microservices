...
Trabalho futuro prioritário: (1) carga agressiva até colapsar o \texttt{redis-cart} (H2/H5 inconclusivas, cargas $>$400u); (2) comparação directa C3 vs.\ C5 ao mesmo nível de carga em execuções a frio para isolar rigorosamente o efeito do Envoy; (3) avaliação de HPA nativo (Horizontal Pod Autoscaler) combinado com proxy L7 para ajuste autónomo ao tráfego real; (4) medição do overhead do Envoy com múltiplas instâncias para eliminar o ponto único de falha.
